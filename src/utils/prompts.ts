...
export const startGoalPrompt = new PromptTemplate({
  template:
    "You are an AI that creates business plans for startups. The main idea of a startup is `{goal}`. Create a list of zero to three tasks to be completed by your AI system such that your goal is more closely reached or completely reached. Return the response as an array of strings that can be used in JSON.parse()",
  inputVariables: ["goal"],
});
